...
CREATE TABLE `Employee_Privileges` (
  ...
  CONSTRAINT `Employee_Privileges_ibfk_1` FOREIGN KEY (`EmployeeID`) REFERENCES `Employees` (`ID`),
  CONSTRAINT `Employee_Privileges_ibfk_2` FOREIGN KEY (`PrivilegeID`) REFERENCES `Privileges` (`PrivilegeID`)
...
CREATE TABLE `Inventory_Transactions` (
  ...
  CONSTRAINT `Inventory_Transactions_ibfk_1` FOREIGN KEY (`TransactionType`) REFERENCES `Inventory_Transaction_Types` (`ID`),
  CONSTRAINT `Inventory_Transactions_ibfk_2` FOREIGN KEY (`ProductID`) REFERENCES `Products` (`ID`),
  CONSTRAINT `Inventory_Transactions_ibfk_3` FOREIGN KEY (`PurchaseOrderID`) REFERENCES `Purchase_Orders` (`PurchaseOrderID`),
  CONSTRAINT `Inventory_Transactions_ibfk_4` FOREIGN KEY (`CustomerOrderID`) REFERENCES `Orders` (`OrderID`)
...
CREATE TABLE `Invoices` (
  ...
  `Shipping` decimal(16,4) DEFAULT NULL,
  `AmountDue` decimal(16,4) DEFAULT NULL,
...
CREATE TABLE `Order_Details` (
  ...
  `UnitPrice` decimal(16,4) DEFAULT NULL,
  ...
  CONSTRAINT `Order_Details_ibfk_3` FOREIGN KEY (`StatusID`) REFERENCES `Order_Details_Status` (`StatusID`)
...
INSERT INTO `Order_Details` VALUES (27,30,34,100.0000,14.0000,0.0000,2,NULL,96,83),(28,30,80,30.0000,3.5000,0.0000,2,NULL,NULL,63),(29,31,7,10.0000,30.0000,0.0000,2,NULL,NULL,64),(30,31,51,10.0000,53.0000,0.0000,2,NULL,NULL,65),(31,31,80,10.0000,3.5000,0.0000,2,NULL,NULL,66),(32,32,1,15.0000,18.0000,0.0000,2,NULL,NULL,67),(33,32,43,20.0000,46.0000,0.0000,2,NULL,NULL,68),(34,33,19,30.0000,9.2000,0.0000,2,NULL,97,81),(35,34,19,20.0000,9.2000,0.0000,2,NULL,NULL,69),(36,35,48,10.0000,12.7500,0.0000,2,NULL,NULL,70),(37,36,41,200.0000,9.6500,0.0000,2,NULL,98,79),(38,37,8,17.0000,40.0000,0.0000,2,NULL,NULL,71),(39,38,43,300.0000,46.0000,0.0000,2,NULL,99,77),(40,39,48,100.0000,12.7500,0.0000,2,NULL,100,75),(41,40,81,200.0000,2.9900,0.0000,2,NULL,101,73),(42,41,43,300.0000,46.0000,0.0000,1,NULL,102,104),(43,42,6,10.0000,25.0000,0.0000,2,NULL,NULL,84),(44,42,4,10.0000,22.0000,0.0000,2,NULL,NULL,85),(45,42,19,10.0000,9.2000,0.0000,2,NULL,103,110),(46,43,80,20.0000,3.5000,0.0000,1,NULL,NULL,86),(47,43,81,50.0000,2.9900,0.0000,1,NULL,NULL,87),(48,44,1,25.0000,18.0000,0.0000,1,NULL,NULL,88),(49,44,43,25.0000,46.0000,0.0000,1,NULL,NULL,89),(50,44,81,25.0000,2.9900,0.0000,1,NULL,NULL,90),(51,45,41,50.0000,9.6500,0.0000,2,NULL,104,116),(52,45,40,50.0000,18.4000,0.0000,2,NULL,NULL,91),(53,46,57,100.0000,19.5000,0.0000,2,NULL,105,101),(54,46,72,50.0000,34.8000,0.0000,2,NULL,106,114),(55,47,34,300.0000,14.0000,0.0000,2,NULL,107,108),(56,48,8,25.0000,40.0000,0.0000,2,NULL,108,106),(57,48,19,25.0000,9.2000,0.0000,2,NULL,109,112),(59,50,21,20.0000,10.0000,0.0000,2,NULL,NULL,92),(60,51,5,25.0000,21.3500,0.0000,2,NULL,NULL,93),(61,51,41,30.0000,9.6500,0.0000,2,NULL,NULL,94),(62,51,40,30.0000,18.4000,0.0000,2,NULL,NULL,95),(66,56,48,10.0000,12.7500,0.0000,2,NULL,111,99),(67,55,34,87.0000,14.0000,0.0000,2,NULL,NULL,117),(68,79,7,30.0000,30.0000,0.0000,2,NULL,NULL,119),(69,79,51,30.0000,53.0000,0.0000,2,NULL,NULL,118),(70,78,17,40.0000,39.0000,0.0000,2,NULL,NULL,120),(71,77,6,90.0000,25.0000,0.0000,2,NULL,NULL,121),(72,76,4,30.0000,22.0000,0.0000,2,NULL,NULL,122),(73,75,48,40.0000,12.7500,0.0000,2,NULL,NULL,123),(74,74,48,40.0000,12.7500,0.0000,2,NULL,NULL,124),(75,73,41,10.0000,9.6500,0.0000,2,NULL,NULL,125),(76,72,43,5.0000,46.0000,0.0000,2,NULL,NULL,126),(77,71,40,40.0000,18.4000,0.0000,2,NULL,NULL,127),(78,70,8,20.0000,40.0000,0.0000,2,NULL,NULL,128),(79,69,80,15.0000,3.5000,0.0000,2,NULL,NULL,129),(80,67,74,20.0000,10.0000,0.0000,2,NULL,NULL,130),(81,60,72,40.0000,34.8000,0.0000,2,NULL,NULL,131),(82,63,3,50.0000,10.0000,0.0000,2,NULL,NULL,132),(83,63,8,3.0000,40.0000,0.0000,2,NULL,NULL,133),(84,58,20,40.0000,81.0000,0.0000,2,NULL,NULL,134),(85,58,52,40.0000,7.0000,0.0000,2,NULL,NULL,135),(86,80,56,10.0000,38.0000,0.0000,1,NULL,NULL,136),(90,81,81,0.0000,2.9900,0.0000,5,NULL,NULL,NULL),(91,81,56,0.0000,38.0000,0.0000,0,NULL,NULL,NULL);
...
CREATE TABLE `Orders` (
  ...
  `ShippingFee` decimal(16,4) DEFAULT NULL,
  `Taxes` decimal(16,4) DEFAULT NULL,
  ...
  KEY `StatusID` (`StatusID`),
  CONSTRAINT `Orders_ibfk_1` FOREIGN KEY (`EmployeeID`) REFERENCES `Employees` (`ID`),
  CONSTRAINT `Orders_ibfk_2` FOREIGN KEY (`CustomerID`) REFERENCES `Customers` (`ID`),
  CONSTRAINT `Orders_ibfk_3` FOREIGN KEY (`ShipperID`) REFERENCES `Shippers` (`ID`),
  CONSTRAINT `Orders_ibfk_4` FOREIGN KEY (`TaxStatus`) REFERENCES `Orders_Tax_Status` (`ID`),
  CONSTRAINT `Orders_ibfk_5` FOREIGN KEY (`StatusID`) REFERENCES `Orders_Status` (`StatusID`)
...
CREATE TABLE `Products` (
  ...
  `Description` text,
  `StandardCost` decimal(16,4) DEFAULT NULL,
  ...
  `MinimumReorderQuantity` smallint DEFAULT NULL,
...
INSERT INTO `Products` VALUES ('4',1,'NWTB-1','Northwind Traders Chai',NULL,13.5000,18.0000,10,40,'10 boxes x 20 bags',0,10,'Beverages',NULL),('10',3,'NWTCO-3','Northwind Traders Syrup',NULL,7.5000,10.0000,25,100,'12 - 550 ml bottles',0,25,'Condiments',NULL),('10',4,'NWTCO-4','Northwind Traders Cajun Seasoning',NULL,16.5000,22.0000,10,40,'48 - 6 oz jars',0,10,'Condiments',NULL),('10',5,'NWTO-5','Northwind Traders Olive Oil',NULL,16.0125,21.3500,10,40,'36 boxes',0,10,'Oil',NULL),('2;6',6,'NWTJP-6','Northwind Traders Boysenberry Spread',NULL,18.7500,25.0000,25,100,'12 - 8 oz jars',0,25,'Jams, Preserves',NULL),('2',7,'NWTDFN-7','Northwind Traders Dried Pears',NULL,22.5000,30.0000,10,40,'12 - 1 lb pkgs.',0,10,'Dried Fruit & Nuts',NULL),('8',8,'NWTS-8','Northwind Traders Curry Sauce',NULL,30.0000,40.0000,10,40,'12 - 12 oz jars',0,10,'Sauces',NULL),('2;6',14,'NWTDFN-14','Northwind Traders Walnuts',NULL,17.4375,23.2500,10,40,'40 - 100 g pkgs.',0,10,'Dried Fruit & Nuts',NULL),('6',17,'NWTCFV-17','Northwind Traders Fruit Cocktail',NULL,29.2500,39.0000,10,40,'15.25 OZ',0,10,'Canned Fruit & Vegetables',NULL),('1',19,'NWTBGM-19','Northwind Traders Chocolate Biscuits Mix',NULL,6.9000,9.2000,5,20,'10 boxes x 12 pieces',0,5,'Baked Goods & Mixes',NULL),('2;6',20,'NWTJP-6','Northwind Traders Marmalade',NULL,60.7500,81.0000,10,40,'30 gift boxes',0,10,'Jams, Preserves',NULL),('1',21,'NWTBGM-21','Northwind Traders Scones',NULL,7.5000,10.0000,5,20,'24 pkgs. x 4 pieces',0,5,'Baked Goods & Mixes',NULL),('4',34,'NWTB-34','Northwind Traders Beer',NULL,10.5000,14.0000,15,60,'24 - 12 oz bottles',0,15,'Beverages',NULL),('7',40,'NWTCM-40','Northwind Traders Crab Meat',NULL,13.8000,18.4000,30,120,'24 - 4 oz tins',0,30,'Canned Meat',NULL),('6',41,'NWTSO-41','Northwind Traders Clam Chowder',NULL,7.2375,9.6500,10,40,'12 - 12 oz cans',0,10,'Soups',NULL),('3;4',43,'NWTB-43','Northwind Traders Coffee',NULL,34.5000,46.0000,25,100,'16 - 500 g tins',0,25,'Beverages',NULL),('10',48,'NWTCA-48','Northwind Traders Chocolate',NULL,9.5625,12.7500,25,100,'10 pkgs',0,25,'Candy',NULL),('2',51,'NWTDFN-51','Northwind Traders Dried Apples',NULL,39.7500,53.0000,10,40,'50 - 300 g pkgs.',0,10,'Dried Fruit & Nuts',NULL),('1',52,'NWTG-52','Northwind Traders Long Grain Rice',NULL,5.2500,7.0000,25,100,'16 - 2 kg boxes',0,25,'Grains',NULL),('1',56,'NWTP-56','Northwind Traders Gnocchi',NULL,28.5000,38.0000,30,120,'24 - 250 g pkgs.',0,30,'Pasta',NULL),('1',57,'NWTP-57','Northwind Traders Ravioli',NULL,14.6250,19.5000,20,80,'24 - 250 g pkgs.',0,20,'Pasta',NULL),('8',65,'NWTS-65','Northwind Traders Hot Pepper Sauce',NULL,15.7875,21.0500,10,40,'32 - 8 oz bottles',0,10,'Sauces',NULL),('8',66,'NWTS-66','Northwind Traders Tomato Sauce',NULL,12.7500,17.0000,20,80,'24 - 8 oz jars',0,20,'Sauces',NULL),('5',72,'NWTD-72','Northwind Traders Mozzarella',NULL,26.1000,34.8000,10,40,'24 - 200 g pkgs.',0,10,'Dairy Products',NULL),('2;6',74,'NWTDFN-74','Northwind Traders Almonds',NULL,7.5000,10.0000,5,20,'5 kg pkg.',0,5,'Dried Fruit & Nuts',NULL),('10',77,'NWTCO-77','Northwind Traders Mustard',NULL,9.7500,13.0000,15,60,'12 boxes',0,15,'Condiments',NULL),('2',80,'NWTDFN-80','Northwind Traders Dried Plums',NULL,3.0000,3.5000,50,75,'1 lb bag',0,25,'Dried Fruit & Nuts',NULL),('3',81,'NWTB-81','Northwind Traders Green Tea',NULL,2.0000,2.9900,100,125,'20 bags per box',0,25,'Beverages',NULL),('1',82,'NWTC-82','Northwind Traders Granola',NULL,2.0000,4.0000,20,100,NULL,0,NULL,'Cereal',NULL),('9',83,'NWTCS-83','Northwind Traders Potato Chips',NULL,0.5000,1.8000,30,200,NULL,0,NULL,'Chips, Snacks',NULL),('1',85,'NWTBGM-85','Northwind Traders Brownie Mix',NULL,9.0000,12.4900,10,20,'3 boxes',0,5,'Baked Goods & Mixes',NULL),('1',86,'NWTBGM-86','Northwind Traders Cake Mix',NULL,10.5000,15.9900,10,20,'4 boxes',0,5,'Baked Goods & Mixes',NULL),('7',87,'NWTB-87','Northwind Traders Tea',NULL,2.0000,4.0000,20,50,'100 count per box',0,NULL,'Beverages',NULL),('6',88,'NWTCFV-88','Northwind Traders Pears',NULL,1.0000,1.3000,10,40,'15.25 OZ',0,NULL,'Canned Fruit & Vegetables',NULL),('6',89,'NWTCFV-89','Northwind Traders Peaches',NULL,1.0000,1.5000,10,40,'15.25 OZ',0,NULL,'Canned Fruit & Vegetables',NULL),('6',90,'NWTCFV-90','Northwind Traders Pineapple',NULL,1.0000,1.8000,10,40,'15.25 OZ',0,NULL,'Canned Fruit & Vegetables',NULL),('6',91,'NWTCFV-91','Northwind Traders Cherry Pie Filling',NULL,1.0000,2.0000,10,40,'15.25 OZ',0,NULL,'Canned Fruit & Vegetables',NULL),('6',92,'NWTCFV-92','Northwind Traders Green Beans',NULL,1.0000,1.2000,10,40,'14.5 OZ',0,NULL,'Canned Fruit & Vegetables',NULL),('6',93,'NWTCFV-93','Northwind Traders Corn',NULL,1.0000,1.2000,10,40,'14.5 OZ',0,NULL,'Canned Fruit & Vegetables',NULL),('6',94,'NWTCFV-94','Northwind Traders Peas',NULL,1.0000,1.5000,10,40,'14.5 OZ',0,NULL,'Canned Fruit & Vegetables',NULL),('7',95,'NWTCM-95','Northwind Traders Tuna Fish',NULL,0.5000,2.0000,30,50,'5 oz',0,NULL,'Canned Meat',NULL),('7',96,'NWTCM-96','Northwind Traders Smoked Salmon',NULL,2.0000,4.0000,30,50,'5 oz',0,NULL,'Canned Meat',NULL),('1',97,'NWTC-82','Northwind Traders Hot Cereal',NULL,3.0000,5.0000,50,200,NULL,0,NULL,'Cereal',NULL),('6',98,'NWTSO-98','Northwind Traders Vegetable Soup',NULL,1.0000,1.8900,100,200,NULL,0,NULL,'Soups',NULL),('6',99,'NWTSO-99','Northwind Traders Chicken Soup',NULL,1.0000,1.9500,100,200,NULL,0,NULL,'Soups',NULL);
...
CREATE TABLE `Purchase_Order_Details` (
  ...
  `PostedToInventory` tinyint(1) NOT NULL,
  `InventoryID` int DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `PurchaseOrderID` (`PurchaseOrderID`),
  KEY `ProductID` (`ProductID`),
  KEY `InventoryID` (`InventoryID`),
  CONSTRAINT `Purchase_Order_Details_ibfk_1` FOREIGN KEY (`PurchaseOrderID`) REFERENCES `Purchase_Orders` (`PurchaseOrderID`),
  CONSTRAINT `Purchase_Order_Details_ibfk_2` FOREIGN KEY (`ProductID`) REFERENCES `Products` (`ID`),
  CONSTRAINT `Purchase_Order_Details_ibfk_3` FOREIGN KEY (`InventoryID`) REFERENCES `Inventory_Transactions` (`TransactionID`)
...
INSERT INTO `Purchase_Order_Details` VALUES (238,90,1,40.00,14.0000,'2006-01-22 00:00:00',1,59),(239,91,3,100.00,8.0000,'2006-01-22 00:00:00',1,54),(240,91,4,40.00,16.0000,'2006-01-22 00:00:00',1,55),(241,91,5,40.00,16.0000,'2006-01-22 00:00:00',1,56),(242,92,6,100.00,19.0000,'2006-01-22 00:00:00',1,40),(243,92,7,40.00,22.0000,'2006-01-22 00:00:00',1,41),(244,92,8,40.00,30.0000,'2006-01-22 00:00:00',1,42),(245,92,14,40.00,17.0000,'2006-01-22 00:00:00',1,43),(246,92,17,40.00,29.0000,'2006-01-22 00:00:00',1,44),(247,92,19,20.00,7.0000,'2006-01-22 00:00:00',1,45),(248,92,20,40.00,61.0000,'2006-01-22 00:00:00',1,46),(249,92,21,20.00,8.0000,'2006-01-22 00:00:00',1,47),(250,90,34,60.00,10.0000,'2006-01-22 00:00:00',1,60),(251,92,40,120.00,14.0000,'2006-01-22 00:00:00',1,48),(252,92,41,40.00,7.0000,'2006-01-22 00:00:00',1,49),(253,90,43,100.00,34.0000,'2006-01-22 00:00:00',1,61),(254,92,48,100.00,10.0000,'2006-01-22 00:00:00',1,50),(255,92,51,40.00,40.0000,'2006-01-22 00:00:00',1,51),(256,93,52,100.00,5.0000,'2006-01-22 00:00:00',1,37),(257,93,56,120.00,28.0000,'2006-01-22 00:00:00',1,38),(258,93,57,80.00,15.0000,'2006-01-22 00:00:00',1,39),(259,91,65,40.00,16.0000,'2006-01-22 00:00:00',1,57),(260,91,66,80.00,13.0000,'2006-01-22 00:00:00',1,58),(261,94,72,40.00,26.0000,'2006-01-22 00:00:00',1,36),(262,92,74,20.00,8.0000,'2006-01-22 00:00:00',1,52),(263,92,77,60.00,10.0000,'2006-01-22 00:00:00',1,53),(264,95,80,75.00,3.0000,'2006-01-22 00:00:00',1,35),(265,90,81,125.00,2.0000,'2006-01-22 00:00:00',1,62),(266,96,34,100.00,10.0000,'2006-01-22 00:00:00',1,82),(267,97,19,30.00,7.0000,'2006-01-22 00:00:00',1,80),(268,98,41,200.00,7.0000,'2006-01-22 00:00:00',1,78),(269,99,43,300.00,34.0000,'2006-01-22 00:00:00',1,76),(270,100,48,100.00,10.0000,'2006-01-22 00:00:00',1,74),(271,101,81,200.00,2.0000,'2006-01-22 00:00:00',1,72),(272,102,43,300.00,34.0000,NULL,0,NULL),(273,103,19,10.00,7.0000,'2006-04-17 00:00:00',1,111),(274,104,41,50.00,7.0000,'2006-04-06 00:00:00',1,115),(275,105,57,100.00,15.0000,'2006-04-05 00:00:00',1,100),(276,106,72,50.00,26.0000,'2006-04-05 00:00:00',1,113),(277,107,34,300.00,10.0000,'2006-04-05 00:00:00',1,107),(278,108,8,25.00,30.0000,'2006-04-05 00:00:00',1,105),(279,109,19,25.00,7.0000,'2006-04-05 00:00:00',1,109),(280,110,43,250.00,34.0000,'2006-04-10 00:00:00',1,103),(281,90,1,40.00,14.0000,NULL,0,NULL),(282,92,19,20.00,7.0000,NULL,0,NULL),(283,111,34,50.00,10.0000,'2006-04-04 00:00:00',1,102),(285,91,3,50.00,8.0000,NULL,0,NULL),(286,91,4,40.00,16.0000,NULL,0,NULL),(288,140,85,10.00,9.0000,NULL,0,NULL),(289,141,6,10.00,18.7500,NULL,0,NULL),(290,142,1,1.00,13.5000,NULL,0,NULL),(292,146,20,40.00,60.0000,NULL,0,NULL),(293,146,51,40.00,39.0000,NULL,0,NULL),(294,147,40,120.00,13.0000,NULL,0,NULL),(295,148,72,40.00,26.0000,NULL,0,NULL);
...
CREATE TABLE `Purchase_Orders` (
  ...
  `PaymentAmount` decimal(16,4) DEFAULT NULL,
  ...
  KEY `StatusID` (`StatusID`),
  CONSTRAINT `Purchase_Orders_ibfk_1` FOREIGN KEY (`SupplierID`) REFERENCES `Suppliers` (`ID`),
  CONSTRAINT `Purchase_Orders_ibfk_2` FOREIGN KEY (`CreatedBy`) REFERENCES `Employees` (`ID`),
  CONSTRAINT `Purchase_Orders_ibfk_3` FOREIGN KEY (`StatusID`) REFERENCES `Purchase_Order_Status` (`StatusID`)
...
-- Dump completed on 2022-11-17 17:59:21
